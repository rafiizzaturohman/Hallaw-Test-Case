        ...
        <div className="mx-6 my-4 md:mx-10">
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="absolute -top-7 xs:-top-9 px-6 sm:-top-10 base:-top-12 md:-top-16 base:px-[70px] flex flex-row items-center space-x-6 base:space-x-24">
                  ...
                  <div className="flex flex-row gap-1 base:gap-2 md:gap-4">
                    ...
                    >
                      <img
                        ...
                        alt="Google Play"
                        className="w-3 h-3 base:w-5 base:h-5 md:w-7 md:h-7"
                      />
                    ...
                    >
                      <img
                        src="/icons/apple.png"
                        alt="Apple"
                        className="w-3 h-4 base:w-5 base:h-6 md:w-6 md:h-7"
                      />

                      <div className="text-white base:-space-y-0.5">
                        <p className="text-[5px] xs:text-[7px] base:text-xs md:text-xs whitespace-nowrap">
                          Download on the
                        </p>

                        <h4 className="capitalize font-bold text-[7px] xs:text-[10px] base:text-base md:text-xl whitespace-nowrap">
                          app store
                        </h4>
                      </div>
                    </Link>
                ...
                <img
                  ...
                  alt="Apps"
                  className="w-32 xs:w-40 sm:w-52 base:w-[18rem] base:h-[20rem] md:w-[386px] md:h-[466px]"
                />
              </div>
            </div>
          </div>
