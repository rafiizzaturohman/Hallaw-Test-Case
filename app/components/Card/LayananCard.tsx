...
const LayananCard: React.FC<LayananCardProps> = ({
  ...
  return (
    <div className="container md:my-4 md:mx-2 px-4 py-4 md:px-1 md:py-1">
      <div className="bg-white shadow-lg shadow/50 h-44 md:h-[466px] md:w-[334px] px-6 py-10 rounded-2xl">
